      ...
      <div style={styles.shell}>
        <div style={styles.visualCol}>
          <div style={styles.visualFrame}>
            ...
            <div style={styles.visualCaption}>
              ...
              <div style={styles.capText}>Live Network Control</div>
              <div style={styles.capLine} />
            </div>
          </div>
        </div>
        ...
        <div style={styles.formCol}>
          <div
            style={{
              ...styles.cardGlow,
              opacity: mouse.active ? 1 : 0.76,
              transform: mouse.active
                ? `translate(${(mouse.x - 50) * 0.14}px, ${(mouse.y - 50) * 0.12}px)`
                : "translate(0,0)",
            }}
          />
...
const styles = {
  ...
  card: {
    ...
    padding: "34px",
    borderRadius: "30px",
    background: "linear-gradient(180deg, rgba(5,10,25,.95), rgba(2,6,18,.98))",
  ...
  logoMiniOrb: {
    ...
    inset: 0,
    borderRadius: "999px",
    background: "radial-gradient(circle, rgba(56,189,248,.10), rgba(56,189,248,0) 68%)",
    filter: "blur(10px)",
  },
  logoMiniCore: {
    width: "18px",
    ...
    boxShadow: "0 0 22px rgba(99,102,241,.22)",
  },
  logoMiniRing: {
    position: "absolute",
    inset: "10px",
    borderRadius: "999px",
    border: "1.5px solid rgba(103,232,249,.32)",
  },
  title: {
    position: "relative",
    zIndex: 1,
