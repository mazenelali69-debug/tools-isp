    ...
    <div style={styles.visualWrap}>
      ...
      <div style={styles.visualTopRow}>
        ...
        <div style={styles.visualStatus}>
          <span style={styles.visualStatusDot} />
          Online
        </div>
      </div>

      <div style={styles.visualCoreOuter}>
        <div style={styles.visualCoreMid}>
          <div style={styles.visualCoreInner}>
            <span style={styles.visualCoreText}>ISP</span>
          </div>
        </div>
      </div>

      <div style={styles.visualArc1} />
      <div style={styles.visualArc2} />
      <div style={styles.visualArc3} />
