          ...
          >
            <div
              style={{
                ...
                display: "grid",
                placeItems: "center",
                background: "linear-gradient(180deg, rgba(8,15,30,.92), rgba(4,8,18,.96))",
                border: "1px solid rgba(96,165,250,.18)",
                boxShadow: "0 0 0 1px rgba(148,163,184,.06), 0 0 28px rgba(56,189,248,.10), inset 0 1px 0 rgba(255,255,255,.05)",
              }}
            >
              <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id="nocNetGrad" x1="6" y1="4" x2="36" y2="38" gradientUnits="userSpaceOnUse">
                ...
                <rect x="6" y="6" width="30" height="30" rx="10" stroke="url(#nocNetGrad)" strokeWidth="1.4" opacity="0.95"/>
                <circle cx="12" cy="13" r="2.2" fill="url(#nocNetGrad)"/>
                <circle cx="30" cy="13" r="2.2" fill="url(#nocNetGrad)"/>
                <circle cx="12" cy="29" r="2.2" fill="url(#nocNetGrad)"/>
                <circle cx="30" cy="29" r="2.2" fill="url(#nocNetGrad)"/>
                <circle cx="21" cy="21" r="3" fill="url(#nocNetGrad)"/>

                <path d="M14 13H28" stroke="url(#nocNetGrad)" strokeWidth="1.6" strokeLinecap="round" opacity="0.9"/>
                <path d="M12.8 15.2L19 19.2" stroke="url(#nocNetGrad)" strokeWidth="1.4" strokeLinecap="round" opacity="0.9"/>
                <path d="M29.2 15.2L23 19.2" stroke="url(#nocNetGrad)" strokeWidth="1.4" strokeLinecap="round" opacity="0.9"/>
                <path d="M12.8 26.8L19 22.8" stroke="url(#nocNetGrad)" strokeWidth="1.4" strokeLinecap="round" opacity="0.9"/>
                <path d="M29.2 26.8L23 22.8" stroke="url(#nocNetGrad)" strokeWidth="1.4" strokeLinecap="round" opacity="0.9"/>
                <path d="M14 29H28" stroke="url(#nocNetGrad)" strokeWidth="1.6" strokeLinecap="round" opacity="0.9"/>
              </svg>
            </div>
            ...
            <div style={{ minWidth: 0 }}>
              <div
                style={{
                  ...
                  lineHeight: 1,
                  letterSpacing: "-.035em",
                  textShadow: "0 0 22px rgba(56,189,248,.08)",
                }}
              >
                NoComment NOC
              </div>
...
<div style={{
  ...
  <svg width="90" height="90" viewBox="0 0 100 100">
    <circle cx="50" cy="50" r="30" stroke="#22d3ee" strokeWidth="1.5" fill="none" opacity="0.3"/>
    <circle cx="50" cy="50" r="20" stroke="#38bdf8" strokeWidth="1.5" fill="none" opacity="0.4"/>
