...
function MotionStyles() {
  return (
    <style>{`
      ...
      @keyframes ncPulseSoft {
        0%   { transform: scale(1); opacity: .78; }
        50%  { transform: scale(1.035); opacity: 1; }
        100% { transform: scale(1); opacity: .78; }
      }

      @keyframes ncRotateSlow {
        0%   { transform: translate(-50%, -52%) rotate(0deg); }
        100% { transform: translate(-50%, -52%) rotate(360deg); }
      }

      @keyframes ncRotateSlowAlt {
        0%   { transform: translate(-50%, -52%) rotate(0deg); }
        100% { transform: translate(-50%, -52%) rotate(-360deg); }
      }

      @keyframes ncArcWave1 {
        0%   { transform: translateX(-50%) translateY(0px) scaleX(1); opacity: .82; }
        50%  { transform: translateX(-50%) translateY(-8px) scaleX(1.02); opacity: 1; }
        100% { transform: translateX(-50%) translateY(0px) scaleX(1); opacity: .82; }
      }

      @keyframes ncArcWave2 {
        0%   { transform: translateX(-50%) translateY(0px) scaleX(1); opacity: .72; }
        50%  { transform: translateX(-50%) translateY(7px) scaleX(1.03); opacity: 1; }
        100% { transform: translateX(-50%) translateY(0px) scaleX(1); opacity: .72; }
      }

      @keyframes ncArcWave3 {
        0%   { transform: translateX(-50%) translateY(0px) scaleX(1); opacity: .76; }
        50%  { transform: translateX(-50%) translateY(-6px) scaleX(1.04); opacity: 1; }
        100% { transform: translateX(-50%) translateY(0px) scaleX(1); opacity: .76; }
      }

      @keyframes ncBlinkDot {
        0%   { opacity: .55; box-shadow: 0 0 0 rgba(34,197,94,0); }
        50%  { opacity: 1; box-shadow: 0 0 20px rgba(34,197,94,.8); }
        100% { opacity: .55; box-shadow: 0 0 0 rgba(34,197,94,0); }
      }

      @keyframes ncGlowBreatheA {
        0%   { transform: scale(1); opacity: .7; }
        50%  { transform: scale(1.08); opacity: 1; }
        100% { transform: scale(1); opacity: .7; }
      }

      @keyframes ncGlowBreatheB {
      ...
      .nc-visual-glow-a {
        animation: ncGlowBreatheA 6.5s ease-in-out infinite;
      }

      .nc-visual-glow-b {
        animation: ncGlowBreatheB 7.2s ease-in-out infinite;
      }

      .nc-visual-core-outer {
        animation: ncRotateSlow 26s linear infinite;
      }

      .nc-visual-core-mid {
        animation: ncRotateSlowAlt 19s linear infinite;
      }

      .nc-visual-core-inner {
        animation: ncPulseSoft 4.2s ease-in-out infinite;
      }

      .nc-visual-arc1 {
        animation: ncArcWave1 3.8s ease-in-out infinite;
      }

      .nc-visual-arc2 {
        animation: ncArcWave2 4.4s ease-in-out infinite;
      }

      .nc-visual-arc3 {
        animation: ncArcWave3 3.2s ease-in-out infinite;
      }

      .nc-visual-float-left {
        animation: ncFloatY 5.5s ease-in-out infinite;
      }

      .nc-visual-float-right {
        animation: ncFloatY 6.3s ease-in-out infinite;
      }

      .nc-visual-mini-grid {
        animation: ncPulseSoft 7.5s ease-in-out infinite;
      }

      .nc-visual-status-dot {
        animation: ncBlinkDot 2.4s ease-in-out infinite;
      }
...
function HeroVisual() {
  return (
    <div className="nc-visual-wrap" style={styles.visualWrap}>
      <div className="nc-visual-glow-a" style={styles.visualGlowA} />
      <div className="nc-visual-glow-b" style={styles.visualGlowB} />
      ...
      <div style={styles.visualTopRow}>
        ...
        <div style={styles.visualStatus}>
          <span className="nc-visual-status-dot" style={styles.visualStatusDot} />
          Online
        </div>
      </div>

      <div className="nc-visual-core-outer" style={styles.visualCoreOuter}>
        <div className="nc-visual-core-mid" style={styles.visualCoreMid}>
          <div className="nc-visual-core-inner" style={styles.visualCoreInner}>
            <span style={styles.visualCoreText}>ISP</span>
          </div>
        </div>
      </div>

      <div className="nc-visual-arc1" style={styles.visualArc1} />
      <div className="nc-visual-arc2" style={styles.visualArc2} />
      <div className="nc-visual-arc3" style={styles.visualArc3} />

      <div className="nc-visual-float-left" style={styles.visualFloatLeft}>
        <span style={styles.visualFloatKicker}>Support</span>
        <strong style={styles.visualFloatValue}>Direct reply</strong>
      </div>

      <div className="nc-visual-float-right" style={styles.visualFloatRight}>
        <span style={styles.visualFloatKicker}>Devices</span>
        <strong style={styles.visualFloatValue}>Modem + Router</strong>
      </div>

      <div className="nc-visual-mini-grid" style={styles.visualBottomGrid}>
...
const styles = {
  ...
  visualCoreOuter: {
    ...
    height: "300px",
    borderRadius: "999px",
    background: "conic-gradient(from 0deg, rgba(96,165,250,0.18), rgba(192,132,252,0.12), rgba(96,165,250,0.04), rgba(96,165,250,0.18))",
  ...
  visualCoreInner: {
    ...
    height: "150px",
    borderRadius: "999px",
    background: "radial-gradient(circle at center, rgba(21,31,56,0.98), rgba(8,14,26,0.98))",
  ...
  visualArc1: {
    ...
    borderTopColor: "rgba(56,189,248,0.88)",
  },
  ...
  visualArc2: {
    ...
    borderTopColor: "rgba(59,130,246,0.82)",
  },
  ...
  visualArc3: {
    ...
    borderTopColor: "rgba(168,85,247,0.88)",
  },
