...
function guessCards(parts) {
  ...
  return {
    radio: radio ? { ...radio, displayName: "Radio1" } : null,
    sfpA:  sfpA  ? { ...sfpA,  displayName: "SFP A" }  : null,
    sfpB:  sfpB  ? { ...sfpB,  displayName: "SFP B" }  : null
  };
}
...
export default function AviatWTM4200Page() {
  ...
  const cards = useMemo(() => guessCards(parts), [parts]);
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <TrafficCard title="Radio1" item={cards.radio} subtitle="Main radio traffic" />
            <TrafficCard title="SFP A" item={cards.sfpA} subtitle="TenGigE1/1 side" />
            <TrafficCard title="SFP B" item={cards.sfpB} subtitle="TenGigE1/2 side" />
          </div>
        </div>
          ...
          <div style={{ padding: 18, display: "grid", gap: 12 }}>
            <div style={{
              ...
              <div style={{ fontSize: 14, color: "#d7e6ff", lineHeight: 1.5 }}>
                Radio1 = wireless radio load. SFP A and SFP B = transport side ports. Combined strip above shows total live throughput.
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 14, color: "#d7e6ff", lineHeight: 1.5 }}>
                If Combined Total approaches 1 Gbps, the link is near saturation. The three cards below help show whether load is mainly on Radio1 or transport ports.
              </div>
            </div>
