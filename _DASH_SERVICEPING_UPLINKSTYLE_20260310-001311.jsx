    ...
    <div className={`ms3-card is-${tone} ${loss > 0 ? "is-loss" : ""}`}>
      ...
      <div className="ms3-gaugeWrap">
        ...
        <div className="ms3-center">
          ...
          <div className={`ms3-ping ${loss > 0 ? "is-loss" : ""}`}>
            {fmtPingMs(row.pingMs, row.alive, loss)}
          </div>
        </div>

        <div className="ms3-total">
      ...
      <div className="ms3-meta">
        <div className="ms3-meta__col">
          <div className="ms3-meta__label">Status</div>
          <div className="ms3-meta__value is-rx">{row.alive ? "UP" : "DOWN"}</div>
        </div>

        <div className="ms3-meta__col">
          <div className="ms3-meta__label">Loss</div>
          <div className="ms3-meta__value is-tx">{Math.round(loss)}%</div>
        </div>

        <div className="ms3-meta__col is-right">
          <div className="ms3-meta__label">Type</div>
          <div className="ms3-meta__value">Ping</div>
        </div>
      </div>
    </div>
  );
