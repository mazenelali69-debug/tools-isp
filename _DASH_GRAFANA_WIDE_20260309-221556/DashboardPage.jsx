...
function PressureList({ rows }) {
  ...
  return (
    <div className="dashx-topbusy">
      {rows.map((row, idx) => {
        const tone = getPressureStatus(row.totalMbps);

        return (
          <div key={row.id} className="dashx-topbusy__row">
            <div className="dashx-topbusy__head">
              <div className="dashx-topbusy__left">
                <span className={"dashx-topbusy__dot is-" + tone} />
                <span className="dashx-topbusy__idx">#{idx + 1}</span>
                <span className="dashx-topbusy__name">{row.name || row.id}</span>
              </div>

              <div className="dashx-topbusy__right">
                <span className="dashx-topbusy__value">{fmtMbps(row.totalMbps)}</span>
              </div>
            </div>

            <div className="dashx-topbusy__bar">
...
export default function DashboardPage() {
  ...
  return (
    <div className="dashx-page">
      ...
      <section className="dashx-row dashx-row--strip">
